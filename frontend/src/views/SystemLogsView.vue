<template>
  <div class="view-container">
    ...
    <el-table :data="tableData" v-loading="loading" border style="width: 100%">
      <el-table-column prop="logId" label="操作编号" width="300" show-overflow-tooltip />
      <el-table-column prop="operatorId" label="操作人学工号" width="120" />
      ...
      <el-table-column prop="operateTime" label="操作时间" width="180">
        <template #default="{ row }">
          {{ row.operateTime ? new Date(row.operateTime).toLocaleString() : '' }}
        </template>
      </el-table-column>
    </el-table>
...
import { getSystemLogs } from '@/api/views';
